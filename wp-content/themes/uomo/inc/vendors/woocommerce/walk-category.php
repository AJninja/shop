<?php
/**
 * Uomo_WC_Product_Cat_Dropdown_Walker class
 *
 * @extends 	Walker
 * @class 		Uomo_WC_Product_Cat_Dropdown_Walker
 * @version		1.6.4
...
if ( ! class_exists( 'Uomo_WC_Product_Cat_Dropdown_Walker', false ) ) :

class Uomo_WC_Product_Cat_Dropdown_Walker extends Walker {
