...
if ( !class_exists("Uomo_Woo_Swatches") ) {
	class Uomo_Woo_Swatches {

		public static function swatches_list( $image_size = 'woocommerce_thumbnail' ) {

			$show_swatches = uomo_get_config( 'show_product_swatches_on_grid' );
			if ( !$show_swatches || !uomo_is_woo_swatches_activated() ) {
				return;
			}
			...
			$attribute_name = uomo_get_config('product_swatches_attribute');
			...
			echo apply_filters( 'uomo_swatches_list', $output, $product_id, $product );
		}
