...
if( ! class_exists( 'Uomo_Elementor_Extensions' ) ) {
    final class Uomo_Elementor_Extensions {
        ...
        public function __construct() {
            ...
            add_filter( 'uomo_generate_post_builder', array( $this, 'render_post_builder' ), 10, 2 );
        ...
        public function add_widget_categories( $elements_manager ) {
            $elements_manager->add_category(
                'uomo-elements',
                [
                    'title' => esc_html__( 'Uomo Elements', 'uomo' ),
                    'icon' => 'fa fa-shopping-bag',
                ]
            );

            $elements_manager->add_category(
                'uomo-header-elements',
                [
                    'title' => esc_html__( 'Uomo Header Elements', 'uomo' ),
                    'icon' => 'fa fa-shopping-bag',
                ]
            );
        ...
        public function elementor_widgets() {
            ...
            if ( uomo_is_ourstores_activated() ) {
                get_template_part( 'inc/vendors/elementor/widgets/our_stores' );
            }
            ...
            if ( uomo_is_mailchimp_activated() ) {
        ...
        public function style() {
            wp_enqueue_style('uomo-flaticon',  get_template_directory_uri() . '/css/flaticon.css');
...
if ( did_action( 'elementor/loaded' ) ) {
    ...
    Uomo_Elementor_Extensions::instance();
}