...
class Uomo_Elementor_Nav_Menu extends Widget_Base {
	...
	public function get_title() {
        return esc_html__( 'Apus Navigation Menu', 'uomo' );
    }
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'content_section',
            [
                'label' => esc_html__( 'Navigation Menu', 'uomo' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => array(
                    ...
                    'st_line' => esc_html__('Line', 'uomo'),
                    'st_no_line' => esc_html__('No Line', 'uomo'),
                    'st_uppercase' => esc_html__('Uppercase', 'uomo'),
                ),
                'default' => ''
            ]
        );
        ...
        $this->start_controls_section(
            'section_menu_style',
            [
                'label' => esc_html__( 'Menu Item', 'uomo' ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            'menu_color',
            [
                'label' => esc_html__( 'Menu Color', 'uomo' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'menu_color_hover',
            [
                'label' => esc_html__( 'Menu Color Hover', 'uomo' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    // Stronger selector to avoid section style from overwriting
        ...
        $this->add_group_control(
            Group_Control_Typography::get_type(),
            [
                'label' => esc_html__( 'Menu Typography', 'uomo' ),
...
Plugin::instance()->widgets_manager->register_widget_type( new Uomo_Elementor_Nav_Menu );