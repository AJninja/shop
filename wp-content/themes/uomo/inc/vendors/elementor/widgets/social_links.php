...
class Uomo_Elementor_Social_Links extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Apus Social Links', 'uomo' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            'social_icon_list',
            [
                'label' => esc_html__( 'Social Icons', 'uomo' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => array(
                    ...
                    'st_ver' => esc_html__('Vertical', 'uomo'),
                ),
                'default' => ''
            ]
        );
...
Plugin::instance()->widgets_manager->register_widget_type( new Uomo_Elementor_Social_Links );