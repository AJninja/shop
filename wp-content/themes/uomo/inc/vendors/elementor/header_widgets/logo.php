...
class Uomo_Elementor_Logo extends Widget_Base {
	...
	public function get_title() {
        return esc_html__( 'Apus Header Logo', 'uomo' );
    }
	...
	protected function _register_controls() {
        ...
        $this->add_control(
            'width',
            [
                'label' => esc_html__( 'Width Image', 'uomo' ),
...
Plugin::instance()->widgets_manager->register_widget_type( new Uomo_Elementor_Logo );