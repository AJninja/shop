...
class Uomo_Socials_Widget extends Apus_Widget {
    public function __construct() {
        parent::__construct(
            'apus_socials_widget',
            esc_html__('Apus Socials', 'uomo'),
            array( 'description' => esc_html__( 'Socials for website.', 'uomo' ), )
        );
    ...
    <div class="apus_socials">
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'socials' )); ?>"><?php esc_html_e('Select socials:', 'uomo'); ?></label>
            <br>
        <?php
...
if ( function_exists('apus_framework_reg_widget') ) {
    apus_framework_reg_widget('Uomo_Socials_Widget');
}