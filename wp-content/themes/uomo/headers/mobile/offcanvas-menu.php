<div id="apus-mobile-menu" class="apus-offcanvas hidden-lg"> 
    <div class="apus-offcanvas-body">
            ...
            <div class="container">
                <div class="row flex-middle">
                    ...
                    <div class="text-center col-xs-6">
                        <?php
                            $logo = uomo_get_config('media-mobile-logo');
                            $logo_url = '';
                            if ( !empty($logo['id']) ) {
                            ...
                            <div class="pull-right">
                                ...
                                <div class="top-cart">
                                    ...
                                    <div class="apus-topcart">
                                        <div class="cart">
                                            <a class="mini-cart" href="<?php echo esc_url( wc_get_cart_url() ); ?>" title="<?php esc_attr_e('View your shopping cart', 'uomo'); ?>">
        ...
        <div class="middle-offcanvas">
            ...
            <?php
                if ( defined('UOMO_WOOCOMMERCE_ACTIVED') && uomo_get_config('show_searchform', true) ) {
        ...
        <?php if ( is_active_sidebar( 'header-mobile-bottom' ) || uomo_get_config('show_login_register', true) ) { ?>
            <div class="header-mobile-bottom">
                <?php if ( uomo_get_config('show_login_register', true) ) { ?>
                    
                    <a class="my-account" href="<?php echo esc_url( get_permalink( get_option('woocommerce_myaccount_page_id') ) ); ?>">
                        <i class="flaticon-user"></i> <?php esc_html_e('My Account', 'uomo'); ?></a>
