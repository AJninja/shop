...
if ( ! empty( $tabs ) ) :
	...
	<?php } elseif ( $layout == 'v4' || $layout == 'v7' || $layout == 'v9' ) { ?>
		<div class="woocommerce-tabs tabs-v2 apus-wc-tabs">
			<?php foreach ( $tabs as $key => $tab ) : ?>
	...
	<?php } elseif ( $layout == 'v11' ) { ?>
		<div class="tabs-v3 apus-wc-tabs">
			<?php foreach ( $tabs as $key => $tab ) : ?>
				<div class="tab-item <?php echo esc_attr( $key ); ?>_tab">
					<div class="head-tab">
