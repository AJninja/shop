...
<article <?php post_class('post post-layout post-grid v5'); ?>>
        ...
        <div class="post-layout-info">
            <a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ); ?>"><?php echo esc_html__('By','uomo') ?> <?php echo get_the_author(); ?></a>
        ...
        <?php if( !empty( get_the_excerpt() ) ){?>
            <div class="description"><?php echo uomo_substring( get_the_excerpt(), 10, '...' ); ?></div>
        <?php } ?>
    <a class="btn-banner hidden-xs" href="<?php the_permalink(); ?>"><?php esc_html_e('READ MORE', 'uomo'); ?></a>
</article>